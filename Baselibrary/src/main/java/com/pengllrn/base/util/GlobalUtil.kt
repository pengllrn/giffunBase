package com.pengllrn.base.util
...
object GlobalUtil {
    ...
    val appPackage: String
        get() = AppContext.getContext().packageName
     ...
     */
    val appName: String
        get() = AppContext.getContext().resources.getString(AppContext.getContext().applicationInfo.labelRes)
    ...
    val appVersionName: String
        get() = AppContext.getContext().packageManager.getPackageInfo(appPackage, 0).versionName
    ...
    val appVersionCode: Int
        get() = AppContext.getContext().packageManager.getPackageInfo(appPackage, 0).versionCode
    ...
    fun getString(resId: Int): String {
        return AppContext.getContext().resources.getString(resId)
    }
    ...
    fun getResourceId(name: String, type: String): Int {
        return AppContext.getContext().resources.getIdentifier(name, type, appPackage)
    }
    ...
    fun getApplicationMetaData(key: String): String? {
        ...
        try {
            applicationInfo = AppContext.getContext().packageManager.getApplicationInfo(appPackage, PackageManager.GET_META_DATA)
    ...
    fun isInstalled(packageName: String): Boolean {
        val packageInfo: PackageInfo? = try {
            AppContext.getContext().packageManager.getPackageInfo(packageName, 0)
        } catch (e: PackageManager.NameNotFoundException) {
            null
        }
...
//     * 判断当前版本是否是开源版本。
//     */
//    fun isOpenSource() = AppContext.getPackageName() == "com.quxianggif.opensource"
