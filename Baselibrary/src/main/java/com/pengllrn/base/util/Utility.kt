    ...
    val appVersion: String
        get() {
            ...
            try {
                ...
                val packInfo = packageManager.getPackageInfo(AppContext.getPackageName(), 0)
    ...
    fun getDeviceSerial(): String {
        if (deviceSerial == null) {
            ...
            if ("google" != appChannel || "samsung" != appChannel) {
                try {
                    deviceId = Settings.Secure.getString(AppContext.getContext().contentResolver, Settings.Secure.ANDROID_ID)
                } catch (e: Exception) {
